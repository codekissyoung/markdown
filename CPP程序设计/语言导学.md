...
```C++
// 函数类型 double( const vector<double>&, int )
double get( const vector<double> &vec，int index ); 

// 函数类型 char& String::(int)
...
![2019-05-19 11-45-02 的屏幕截图.png](http://img.codekissyoung.com/2019/05/19/d7416228a1fa1e531a7c0731e61af0b6.png)
...
![2019-05-19 11-51-48 的屏幕截图.png](http://img.codekissyoung.com/2019/05/19/498a11c679de0b34e80bb8699a3319d1.png)
...
![2019-05-20 00-16-38 的屏幕截图.png](http://img.codekissyoung.com/2019/05/20/8637cb844bba31218fdda4e53c2e798e.png)
...
![拷贝构造函数 拷贝赋值运算符](http://img.codekissyoung.com/2019/05/20/f7fe9139fd0e6851bf687851e0be536e.png)
...
![2019-05-20 00-55-33 的屏幕截图.png](http://img.codekissyoung.com/2019/05/20/edaa5922688c732d2eae26f78de66753.png)
...
![内存布局](http://img.codekissyoung.com/2019/05/22/aba90838b000f55493f2bdb9ddcbf2a3.png)
...
![WX20190522-124601.png](http://img.codekissyoung.com/2019/05/22/9d726fc56128785feb80f90a3c8d2d8a.png)

![WX20190522-124756.png](http://img.codekissyoung.com/2019/05/22/ca3a1e5fbba63d5aeebe9c4f15c06234.png)

![WX20190522-124954.png](http://img.codekissyoung.com/2019/05/22/ebab44e37b94c964872e1228a0764a72.png)
...
![WX20190522-125638.png](http://img.codekissyoung.com/2019/05/22/1bd10b9f9a3726c7895e28237cb38299.png)
...
![WX20190522-140300.png](http://img.codekissyoung.com/2019/05/22/6b99f82df3b6a2fd089d3abc06e5e5f9.png)

`istream`类：

![WX20190522-140312.png](http://img.codekissyoung.com/2019/05/22/4bcd3249f5a6a5301849e68ef0447270.png)
...
![WX20190522-142304.png](http://img.codekissyoung.com/2019/05/22/668aea54f080ed7065a387732db5fde7.png)
...
![WX20190522-143703.png](http://img.codekissyoung.com/2019/05/22/dd556711649722a45bfd8b65423e2cb7.png)

### map

编写程序在一个(名字，数值)对列表中查找给定名字是一项很烦人的工作。而且，除非列表很短，否则顺序搜索是非常低效的。标准库提供了一个名为`map`的搜索树(红黑树)：

![WX20190522-143908.png](http://img.codekissyoung.com/2019/05/22/c33e2e9cd149ab129a8f4656923c01db.png)
...
![WX20190522-144419.png](http://img.codekissyoung.com/2019/05/22/9914c7e99faf0e658a0132a474699ea0.png)

容器参考表：

![WX20190522-144622.png](http://img.codekissyoung.com/2019/05/22/c8162e35a70e6c82c74f174a949f4e2d.png)
...
![WX20190522-151718.png](http://img.codekissyoung.com/2019/05/22/8fb707422f1c5f21e077ec441aeb4091.png)
...
![指针作为迭代器](http://img.codekissyoung.com/2019/05/23/fa8c77120a35c85b15bf27f178bf531c.png)

一个`vector`迭代器也可以实现为 一个指向起始位置的指针 + 一个偏移量:

![一个指向起始位置的指针 + 一个偏移量](http://img.codekissyoung.com/2019/05/23/6c513b9c23a4f383f937c7653b1e6d85.png)

一个`list`迭代器必须是某种比简单指针更复杂的东西，因为一个`list`元素通常不知道它的下一个元素在哪里。因此，一个`list`迭代器可能是指向一个链接(链表指针)的指针:

![list迭代器](http://img.codekissyoung.com/2019/05/23/e1b14ddf9971f3b3cae2a2c778053086.png)
...
![算法库概览](http://img.codekissyoung.com/2019/05/23/7dc552ee2b761d51f7e19c755b3b95d7.png)
...
![特殊容器](http://img.codekissyoung.com/2019/05/23/236c08a113bb2dd82c307c9bcb4f6b1f.png)
...
![数学库](http://img.codekissyoung.com/2019/05/23/1401a722a49ec646db54bda6f08132a0.png)

### 数值算法

![数值算法](http://img.codekissyoung.com/2019/05/23/af5b444772f547ab446b4be2205314cd.png)
![数值算法](http://img.codekissyoung.com/2019/05/23/fc830ec91d776bd0a2146cb53e3a8b5e.png)
...
![C/C++ 兼容性](http://img.codekissyoung.com/2019/05/23/b19feb532f9686676d7f95bacb80ef12.png)
